...
IMMOPROJ = dict(
 ...
 deploy_col='Bereitstellung',
 ts_name='LiquiMerge', ts_vendor_line='LiquiMerge · Software für Bauträger · Server in Deutschland',
 ts_blurb='Liquiditätsplanung und Rechnungsmanagement für mittelständische Bauträger und Bauunternehmen – mit KI-Rechnungserfassung (ZUGFeRD/XRechnung), cent-genauer Zahlbetragsermittlung und projektscharfer 24-Monats-Liquiditätsprognose. Server in Deutschland.',
 ts_tags=['KI-Rechnungserfassung','24-Monats-Prognose (projektscharf)','Vier-Augen-Freigabe','Server in Deutschland'],
 why_sub='Vier Stärken heben LiquiMerge vom Feld ab.',
 why=[
  dict(icon=ICON['droplet'], score='10 / 10', title='Liquidität projektscharf', text='24-Monats-Prognose je Bankkonto (Giro, Treuhand, Darlehen) – mit Unterdeckungs-Warnung und Soll-Ist-Vergleich.'),
  dict(icon=ICON['ki'], score='9 / 10', title='KI-Rechnungserfassung', text='PDF-Upload mit KI-Auslese, Vorrang für ZUGFeRD/XRechnung und cent-genaue Zahlbeträge inkl. Einbehalt und Skonto.'),
  dict(icon=ICON['euro'], score='10 / 10', title='Darlehen &amp; Finanzierung', text='Tilgungspläne (Annuität/endfällig, Sondertilgungen) fließen direkt in die Liquiditätsprognose.'),
  dict(icon=ICON['chart'], score='8 / 10', title='Budget &amp; DIN-276-Reports', text='Gesamtbudget nach DIN 276 × Baukörper, Beauftragt-vs-Budget und Reports in Bank-/Mezzanine-Sicht.'),
 ],
 ...
 products=[
  dict(name='LiquiMerge', short='LiquiMerge', vendor='', deploy='Cloud/SaaS', score=90.8, blurb='Testsieger. Liquiditätsplanung und Rechnungsmanagement für mittelständische Bauträger – KI-Rechnungserfassung, projektscharfe 24-Monats-Prognose und Darlehensplanung, die direkt in die Liquidität fließt.'),
 ...
 criteria=[
  ...
  dict(label='Rechnungen & Freigaben', weight=11, scores=[9,10,8,6,6,6]),
  dict(label='Multiprojekt-Controlling', weight=10, scores=[9,8,10,7,7,6]),
  dict(label='Schnittstellen & Export', weight=9, scores=[7,8,8,8,7,6]),
